    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="{{ asset('frontend/assets/img/tour10.jpg') }}"
                    alt=""
                    class="islands__bg"
                />
...
>
    <div class="logos__container container grid">
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/crdb.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/image2.jpg') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/booking.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/cocacola.png') }}" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="{{ asset('frontend/assets/img/dance.jpg') }}" alt="" style="height:100%" />
            </div>
        </div>
