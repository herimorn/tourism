        ...
        <header class="header" id="header">
            <nav class="nav container">
                <a href="{{ route('homepage') }}" class="nav__logo"
                    >BERLYN<i class="bx bxs-map"></i> TRAVEL</a
                >
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=0743346879&text=I want to booking" class="button nav__button">Booking Now</a>
            </nav>
        </header>
            ...
            <div class="footer__container container grid">
                <div>
                    <a href="{{ route('homepage') }}" class="footer__logo">
                        BERLYN<i class="bx bxs-map"></i> TRAVEL
                    </a>
